          ...
          <div class="row">
            <div class="col-lg-6">
              <?= $this->session->flashdata('message')?>
                  ...
                  <h3>IDE</h3>
    <p>IDE (Integrated Development Environment) adalah program komputer yang memiliki beberapa fasilitas yang diperlukan dalam pembangunan perangkat lunak. Tujuan dari IDE adalah untuk menyediakan semua utilitas yang diperlukan dalam membangun perangkat lunak.</p>
              
              
    <ul>
      <p>Sebuah IDE, atau secara bebas dapat diterjemahkan sebagai Lingkungan Pengembangan Terpadu, setidaknya memiliki fasilitas:</p>
      <li>Editor, yaitu fasilitas untuk menuliskan kode sumber dari perangkat lunak.</li>
      <li>Compiler, yaitu fasilitas untuk mengecek sintaks dari kode sumber kemudian mengubah dalam bentuk binari yang sesuai dengan bahasa mesin.</li>
      <li> Linker, yaitu fasilitas untuk menyatukan data binari yang beberapa kode sumber yang dihasilkan compiler sehingga data-data binari tersebut menjadi satu kesatuan dan menjadi suatu program komputer yang siap dieksekusi.</li>
      <li>Debuger, yaitu fasilitas untuk mengetes jalannya program, untuk mencari bug/kesalahan yang terdapat dalam program.</li>
    </ul>
